...
<div class="container custom-container">
    ...
    <input type="hidden" id="sessionEmpty" value="<?php (bool) $_SESSION["isEmptyPanier"]; ?>">
    <?php if (!empty($_SESSION['panier'])): ?>
        ...
        <form method="post" id="payerForm" action="/payer">
            ...
            <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="containe-info">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="quantity-<?= $key ?>" name="items[<?= $key ?>][quantity]" value="1"
                                        min="1" max="10" data-price="<?= $item['prix'] ?>">
                                </div>
                ...
                <div class="text-decoration">Prix total: <span class="text-decoration"
                        id="prixTotal"><?= $prixTotal ?></span>$</div>
                <input type="hidden" name="prixTotal" id="hiddenPrixTotal" value="<?= $prixTotal ?>">

                <div class="button-container">
                    <button class="btn btn-success button" type="button" onclick="pay()" name="payer">Payer</button>
                </div>
